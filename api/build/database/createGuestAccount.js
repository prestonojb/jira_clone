...
const seedIssues = (project) => {
    ...
    const issues = [
        ...
        (0, typeorm_1.createEntity)(entities_1.Issue, {
            ...
            type: issues_1.IssueType.TASK,
            status: issues_1.IssueStatus.BACKLOG,
            priority: issues_1.IssuePriority.LOW,
            listPosition: 2,
        ...
        (0, typeorm_1.createEntity)(entities_1.Issue, {
            ...
            priority: issues_1.IssuePriority.HIGHEST,
            listPosition: 5,
        ...
        (0, typeorm_1.createEntity)(entities_1.Issue, {
            ...
            type: issues_1.IssueType.TASK,
            status: issues_1.IssueStatus.INPROGRESS,
            priority: issues_1.IssuePriority.LOWEST,
            listPosition: 7,
        ...
        (0, typeorm_1.createEntity)(entities_1.Issue, {
            ...
            type: issues_1.IssueType.TASK,
            status: issues_1.IssueStatus.DONE,
            priority: issues_1.IssuePriority.MEDIUM,
            listPosition: 7,
...
const seedComments = (issues, users) => {
    const comments = [
        (0, typeorm_1.createEntity)(entities_1.Comment, {
...
const createGuestAccount = () => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield seedUsers();
    const project = yield seedProject(users);
    const issues = yield seedIssues(project);
    yield seedComments(issues, project.users);
    return users[2];
});
exports.default = createGuestAccount;
//# sourceMappingURL=createGuestAccount.js.map